...
| 分组 | 数量 | 分组说明 |
| --- | ---: | --- |
| [🤖 AI 智能体与开发工具](#ai-agents) | 51 | 智能体框架、AI 编程助手、技能系统与多智能体协作工具，适合搭建自动执行任务的 AI 工作流。 |
...
| [🧩 编程学习、设计与资源导航](#learning-resources) | 5 | 编程教程、学习路线、设计资料与精选资源列表，适合系统学习和快速查找参考材料。 |
| [🎲 其他工具与兴趣项目](#other-interests) | 6 | 暂不适合归入上述主题的数据工具、内容项目与实验性作品，保留独立入口以便持续整理。 |
...
**本组共 51 个项目**，按 GitHub Star 数从高到低排列。
...
- [**obra/superpowers**](https://github.com/obra/superpowers) — An agentic skills framework & software development methodology that works. · `Shell` · ⭐ 282k
- [**NousResearch/hermes-agent**](https://github.com/NousResearch/hermes-agent) — The agent that grows with you · `Python` · ⭐ 242k
- [**deepseek-ai/deepseek-harness**](https://github.com/deepseek-ai/deepseek-harness) — DeepSeek Harness: Everything is a Plugin. · `TypeScript` · ⭐ 212k
- [**multica-ai/andrej-karpathy-skills**](https://github.com/multica-ai/andrej-karpathy-skills) — A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's observations on LLM coding pitfalls. · 未标注语言 · ⭐ 210k
- [**anomalyco/opencode**](https://github.com/anomalyco/opencode) — The open source coding agent. · `TypeScript` · ⭐ 204k
...
- [**anthropics/skills**](https://github.com/anthropics/skills) — Public repository for Agent Skills · `Python` · ⭐ 174k
...
- [**openai/codex**](https://github.com/openai/codex) — Lightweight coding agent that runs in your terminal · `Rust` · ⭐ 122k
- [**VoltAgent/awesome-design-md**](https://github.com/VoltAgent/awesome-design-md) — A collection of DESIGN.md files analysis by popular brand design systems. Drop one into your project and let coding agents generate a matching UI. · 未标注语言 · ⭐ 114k
...
- [**unclecode/crawl4ai**](https://github.com/unclecode/crawl4ai) — 🚀🤖 Crawl4AI: Open-source LLM Friendly Web Crawler & Scraper. Don't be shy, join here: https://discord.gg/jP8KfhDhyN · `Python` · ⭐ 81k
...
- [**code-yeongyu/oh-my-openagent**](https://github.com/code-yeongyu/oh-my-openagent) — OmO: Drop your tokens. Ultrawork. Done. · `TypeScript` · ⭐ 69k
...
- [**tinyhumansai/openhuman**](https://github.com/tinyhumansai/openhuman) — OpenHuman is an open source personal AI for Mac, Windows and Linux — local-first memory, agent orchestration, and deep research. · `Rust` · ⭐ 39k
- [**agentscope-ai/QwenPaw**](https://github.com/agentscope-ai/QwenPaw) — Your Personal AI Assistant; easy to install, deploy on your own machine or on the cloud; supports multiple chat apps with easily extensible capabilities. · `Python` · ⭐ 35k
...
- [**Tencent/WeKnora**](https://github.com/Tencent/WeKnora) — Open-source LLM knowledge platform: turn raw documents into a queryable RAG, an autonomous reasoning agent, and a self-maintaining Wiki. · `Go` · ⭐ 21k
- [**KKKKhazix/khazix-skills**](https://github.com/KKKKhazix/khazix-skills) — 数字生命卡兹克开源的 AI Skills 合集 | Agent Skills: leader（帮你定义目标）, neat-freak 洁癖, hv-analysis, khazix-writer & more — Claude Code, Codex & 40+ agents · `Python` · ⭐ 20k
...
- [**ai-shifu/ChatALL**](https://github.com/ai-shifu/ChatALL) — Concurrently chat with ChatGPT, Bing Chat, Bard, Alpaca, Vicuna, Claude, ChatGLM, MOSS, 讯飞星火, 文心一言 and more, discover the best answers · `JavaScript` · ⭐ 16k
...
- [**chuspeeism/dashi-ppt-skill**](https://github.com/chuspeeism/dashi-ppt-skill) — An AI-agent skill that generates browser-editable presentations from multiple visual themes, exportable to HTML, PDF, and PPTX. · `JavaScript` · ⭐ 7.5k
- [**iflytek/skillhub**](https://github.com/iflytek/skillhub) — Self-hosted, open-source agent skill registry for enterprises. Publish & version skill packages, govern with RBAC and audit logs, deploy on-premise with Docker or Kubernetes. · `Java` · ⭐ 5k
...
- [**XiaoDuoYa/codex-with-chatgpt**](https://github.com/XiaoDuoYa/codex-with-chatgpt) — ChatGPT thinks. Codex works. Use ChatGPT as the planning brain while keeping the Codex harness. · `TypeScript` · ⭐ 2.5k
...
- [**xyTom/coding-tools-mcp**](https://github.com/xyTom/coding-tools-mcp) — Give any AI agent the ability to code · `Python` · ⭐ 986
- [**runningZ1/union-search-skill**](https://github.com/runningZ1/union-search-skill) — 统一搜索工具集 - 跨平台内容搜索解决方案，支持 B 站/抖音/小红书/GitHub/Twitter 等 20+ 平台 · `Python` · ⭐ 654
- [**wudy29/engineering-bridge**](https://github.com/wudy29/engineering-bridge) — 让 Chat 直接调度、监督本地 Codex / DSH：不再来回搬运提示词和结果，在对话中发起任务、审阅/修正补丁，确认 APPLY 后受控写入。 · `TypeScript` · ⭐ 110
...
- [**open-webui/open-webui**](https://github.com/open-webui/open-webui) — User-friendly AI Interface (Supports Ollama, OpenAI API, ...) · `Python` · ⭐ 151k
- [**deepseek-ai/DeepSeek-V3**](https://github.com/deepseek-ai/DeepSeek-V3) — 暂无项目简介 · `Python` · ⭐ 104k
- [**Lordog/dive-into-llms**](https://github.com/Lordog/dive-into-llms) — 《动手学大模型Dive into LLMs》系列编程实践教程 · `Jupyter Notebook` · ⭐ 52k
...
- [**CCCCY-ci/ctxhop**](https://github.com/CCCCY-ci/ctxhop) — Continue the same AI coding session on another machine. No server, no account, your own storage. · `Go` · ⭐ 32
...
- [**alibaba/MNN**](https://github.com/alibaba/MNN) — MNN: A blazing-fast, lightweight inference engine battle-tested by Alibaba, powering high-performance on-device LLMs and Edge AI. · `C++` · ⭐ 16k
- [**PaddlePaddle/PaddleDetection**](https://github.com/PaddlePaddle/PaddleDetection) — Object Detection toolkit based on PaddlePaddle. It supports object detection, instance segmentation, multiple object tracking and real-time multi-person keypoint detection. · `Python` · ⭐ 14k
- [**iscyy/ultralyticsPro**](https://github.com/iscyy/ultralyticsPro) — 🔥🔥🔥 专注于YOLO11，YOLOv8、TYOLOv12、YOLOv10、RT-DETR、YOLOv7、YOLOv5改进模型，Support to improve backbone, neck, head, loss, IoU, NMS and other modules🚀 · `Python` · ⭐ 3k
...
- [**xahidbuffon/Awesome_Underwater_Datasets**](https://github.com/xahidbuffon/Awesome_Underwater_Datasets) — Pointers to large-scale underwater datasets and relevant resources. · 未标注语言 · ⭐ 707
...
- [**gaia-solutions-on-demand/DFireDataset**](https://github.com/gaia-solutions-on-demand/DFireDataset) — D-Fire: an image data set for fire and smoke detection. · `Python` · ⭐ 441
...
- [**jianzhang96/MSD**](https://github.com/jianzhang96/MSD) — mobile phone screen surface defect segmentation (detection) dataset. · 未标注语言 · ⭐ 77
- [**garlic-byte/yolov8_distillation**](https://github.com/garlic-byte/yolov8_distillation) — 轻量化剪枝+蒸馏 · `Python` · ⭐ 72
...
- [**Mr-TalhaIlyas/CWD30**](https://github.com/Mr-TalhaIlyas/CWD30) — Official Repository for CWD30 Dataset · `Python` · ⭐ 43
...
- [**iscyy/YOLOv10Pro**](https://github.com/iscyy/YOLOv10Pro) — 专注于改进YOLOv10模型 · `Python` · ⭐ 8
- [**RadheTians/Rice-Crop-Insects-and-Weed-Dataset**](https://github.com/RadheTians/Rice-Crop-Insects-and-Weed-Dataset) — 暂无项目简介 · 未标注语言 · ⭐ 4
- [**rezaul-h/rice-weed-detection**](https://github.com/rezaul-h/rice-weed-detection) — 暂无项目简介 · `Jupyter Notebook` · ⭐ 1
...
> 公开数据集、论文代码、实验项目与调优手册，适合科研复现、课程学习和模型评估。

**本组共 25 个项目**，按 GitHub Star 数从高到低排列。

<details>
<summary><strong>展开项目清单</strong></summary>

- [**google-research/tuning_playbook**](https://github.com/google-research/tuning_playbook) — A playbook for systematically maximizing the performance of deep learning models. · 未标注语言 · ⭐ 30k
...
- [**2417677728/OFDM**](https://github.com/2417677728/OFDM) — A MATLAB program to help understand OFDM. · `MATLAB` · ⭐ 345
...
- [**rpl-cmu/CMU-GPR-Dataset**](https://github.com/rpl-cmu/CMU-GPR-Dataset) — Dataset and utilities for research on localizing ground penetrating radar (GPR). · `Python` · ⭐ 117
...
- [**CUMT-AIPR-Lab/CUMT-AIPR-Lab**](https://github.com/CUMT-AIPR-Lab/CUMT-AIPR-Lab) — 暂无项目简介 · 未标注语言 · ⭐ 94
...
- [**QiangZiBro/kai_character_dataset**](https://github.com/QiangZiBro/kai_character_dataset) — 颜真卿书法家楷书风格的书法汉字图像数据集，图像数共计856张，已开源。 · 未标注语言 · ⭐ 26
- [**cracer/CNN-LSTM-Flow-Analysis**](https://github.com/cracer/CNN-LSTM-Flow-Analysis) — 基于CNN+LSTM时空神经网络的在线流量分类模型 · 未标注语言 · ⭐ 16
- [**laozhuang727/Chinese_medical_NLP**](https://github.com/laozhuang727/Chinese_medical_NLP) — 中文医疗NLP领域 数据集，论文 ，知识图谱，语料，工具包 · 未标注语言 · ⭐ 16
- [**jiwei0921/Deep_Learning-Notebook**](https://github.com/jiwei0921/Deep_Learning-Notebook) — Paper list · 未标注语言 · ⭐ 14
- [**EugeneJie/MyGPR**](https://github.com/EugeneJie/MyGPR) — 用机器学习方法对GPR模拟数据进行异常定位和分类 · `Jupyter Notebook` · ⭐ 12
- [**LiuGaoyong/VASP-Compile**](https://github.com/LiuGaoyong/VASP-Compile) — 暂无项目简介 · 未标注语言 · ⭐ 9
- [**Wei-dongyuan/diseases_detection_model**](https://github.com/Wei-dongyuan/diseases_detection_model) — 病虫害检测后端model · `Python` · ⭐ 7
- [**winner158/SmartExpress**](https://github.com/winner158/SmartExpress) — 快递信息数据集 · `Java` · ⭐ 5
- [**zp19990818/dataset-rename**](https://github.com/zp19990818/dataset-rename) — 从不同路径读取数据并输出到同一路径 · `Python` · ⭐ 1
...
- [**2dust/v2rayNG**](https://github.com/2dust/v2rayNG) — A V2Ray client for Android, support Xray core and v2fly core · `Kotlin` · ⭐ 62k
...
<a id="network-selfhosted"></a>
## 🌐 网络代理、下载与自托管

> 代理客户端、下载管理、远程访问和自托管服务，适合构建稳定可控的个人网络工具箱。

**本组共 7 个项目**，按 GitHub Star 数从高到低排列。

<details>
<summary><strong>展开项目清单</strong></summary>

- [**awesome-selfhosted/awesome-selfhosted**](https://github.com/awesome-selfhosted/awesome-selfhosted) — A list of Free Software network services and web applications which can be hosted on your own servers · 未标注语言 · ⭐ 317k
- [**clash-verge-rev/clash-verge-rev**](https://github.com/clash-verge-rev/clash-verge-rev) — A modern GUI client based on Tauri, designed to run in Windows, macOS and Linux for tailored proxy experience · `TypeScript` · ⭐ 142k
- [**2dust/v2rayN**](https://github.com/2dust/v2rayN) — A GUI client for Windows, Linux and macOS, support Xray and sing-box and others · `C#` · ⭐ 115k
...
> Windows 系统维护、安装重装、功能管理和运维脚本，适合日常管理与故障处理。
...
- [**massgravel/Microsoft-Activation-Scripts**](https://github.com/massgravel/Microsoft-Activation-Scripts) — Open-source Windows and Office activator featuring HWID, Ohook, TSforge, and Online KMS activation methods, along with advanced troubleshooting. · `Batchfile` · ⭐ 189k
- [**zbezj/HEU_KMS_Activator**](https://github.com/zbezj/HEU_KMS_Activator) — 暂无项目简介 · 未标注语言 · ⭐ 43k
- [**game1024/OpenSpeedy**](https://github.com/game1024/OpenSpeedy) — 🎮 An open-source game speed modifier. · `TypeScript` · ⭐ 18k
- [**bin456789/reinstall**](https://github.com/bin456789/reinstall) — 一键DD/重装脚本 (One-click reinstall OS on VPS) · `Shell` · ⭐ 13k
- [**thebookisclosed/ViVe**](https://github.com/thebookisclosed/ViVe) — C# library and console app for using new feature control APIs available in Windows 10 version 2004 and newer · `C#` · ⭐ 7.7k
...
<a id="automation-productivity"></a>
## ⚙️ 自动化、爬虫与效率工具

> 网页采集、RPA、命令行脚本和批处理工作流，用于减少重复操作并提升信息处理效率。

**本组共 6 个项目**，按 GitHub Star 数从高到低排列。
...
- [**namecallfilter/tiktokmodcloud**](https://github.com/namecallfilter/tiktokmodcloud) — Automated archive of TikTok Mod and Plugin APK files from TikTokModCloud. This repository includes a CLI tool for downloading the latest versions and automated workflows to maintai · `TypeScript` · ⭐ 380
...
> 编程教程、学习路线、设计资料与精选资源列表，适合系统学习和快速查找参考材料。

**本组共 5 个项目**，按 GitHub Star 数从高到低排列。

<details>
<summary><strong>展开项目清单</strong></summary>

- [**codecrafters-io/build-your-own-x**](https://github.com/codecrafters-io/build-your-own-x) — Master programming by recreating your favorite technologies from scratch. · `Markdown` · ⭐ 545k
...
- [**zp19990818/tudui-pytorch**](https://github.com/zp19990818/tudui-pytorch) — b站小土堆pytorch教学 · `Python` · ⭐ 1
...
> 暂不适合归入上述主题的数据工具、内容项目与实验性作品，保留独立入口以便持续整理。
...
- [**Lin-arm/GKD_subscription**](https://github.com/Lin-arm/GKD_subscription) — 用于安卓 GKD 的第三方订阅规则 (👻Fork版) · `TypeScript` · ⭐ 5k
...
- [**guoguoguoguoxiaoqiang/douyin_data**](https://github.com/guoguoguoguoxiaoqiang/douyin_data) — 抖音用户视频偏好分析 · `Jupyter Notebook` · ⭐ 1
