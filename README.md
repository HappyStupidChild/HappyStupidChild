...
[![公开仓库](https://img.shields.io/badge/公开仓库-22-181717?style=flat-square&logo=github)](https://github.com/HappyStupidChild?tab=repositories)
[![Fork](https://img.shields.io/badge/Fork-21-2563EB?style=flat-square&logo=git)](https://github.com/HappyStupidChild?tab=repositories&type=fork)
[![Star 收藏](https://img.shields.io/badge/Star_收藏-164-FFB000?style=flat-square&logo=githubsponsors)](https://github.com/HappyStupidChild?tab=stars)
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🤖 AI、智能体与研究</h3>
      <p><a href="https://github.com/HappyStupidChild/engineering-bridge"><code>engineering bridge</code></a>
        &nbsp;·&nbsp;
...
| 分类 | 数量 | 代表项目 |
| --- | ---: | --- |
| 🤖 AI 智能体与开发工具 | 47 | LangChain、OpenCode、OpenClaw、Agent Skills |
...
<div align="center">
  <a href="./STAR-CATALOG.md"><strong>查看 164 个 Star 的完整分类目录 →</strong></a>
</div>

> 本区域由 GitHub Actions 自动维护。分类按项目的主要用途归档，具有交叉属性的项目只放入一个主分类。我的 21 个功能仓库均为 Fork，版权与成果属于原作者和贡献者。
<!-- AUTO:RADAR:END -->
